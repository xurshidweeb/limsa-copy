...
function Home() {
  ...
  return (
    <div className="relative">
      <img src={bg} alt="" className="absolute object-cover top-0 w-full h-screen brightness-10" />
      <div className="bg-gradient-to-r pt-[60px]  px-5 text-white relative">
        <div className="container flex justify-between pt-10 max-[750px]:flex-col gap-8 items-center ">
          <div className="w-[45%] max-[750px]:w-[90%] max-[750px]:text-center">
            <h2 className="font-bold text-3xl mb-5 max-[750px]:text-2xl ">{t('home.title')}</h2>
        ...
        <div className="flex justify-between items-center container px-4 max-[1216px]:flex-col max-[1216px]:text-center ">
          <div className="flex w-[600px] max-[500px]:hidden max-[600px]:w-[400px] max-[400px]:w-[300px]  max-[650px]:flex-col max-[650px]:items-center  gap-8">
            <img
              src={img1}
              alt=""
              className="w-full max-[770px]:m-0 max-[770px]:w-[300px] max-[770px]:h-[30 0px] object-cover max-[650px]:w-[500px] max-[450px]:w-[300px] mb-25"
            />
            <img
              src={img2}
              alt=""
      ...
      <div className="fast-marque bg-[#161616]">
        <Marquee className="" speed={100}>
          <div className="text-4xl font-bold mr-20 text-white">{t('fast.fast1')}</div>
          <div className="text-4xl font-bold mr-20 text-white">/</div>
          <div className="text-4xl font-bold mr-20 text-white">{t('fast.fast2')}</div>
          <div className="text-4xl font-bold mr-20 text-white">/</div>
          <div className="text-4xl font-bold mr-20 text-white">{t('fast.fast3')}</div>
          <div className="text-4xl font-bold mr-20 text-white">/</div>
          <div className="text-4xl font-bold mr-20 text-white">{t('fast.fast4')}</div>
          <div className="text-4xl font-bold mr-20 text-white">/</div>
        </Marquee>
      </div>
